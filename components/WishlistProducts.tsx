    ...
    <Container>
      {favoriteProduct?.length > 0 ? (
                        ...
                        {product?.images && (
                          ...
                          >
                            <Image
                              ...
                              width={80}
                              height={80}
                              className="rounded-md group-hover:scale-105 hoverEffect w-20 h-20 object-contain"
                            />
                          </Link>
                        )}
        ...
        <div className="flex min-h-[400px] flex-col items-center justify-center space-y-6 px-4 text-center">
          ...
          <div className="flex items-center justify-center mb-4 h-6 w-6 animate-ping rounded-full bg-muted-foreground/20">
            <Heart
