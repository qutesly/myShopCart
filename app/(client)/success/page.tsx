  ...
  return (
    <div className="py-5 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center mx-4">
      <motion.div
        ...
        className="bg-white rounded-2xl shadow-2xl p-6 max-w-xl w-full text-center flex flex-col gap-8"
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          transition={{ delay: 0.2, type: "spring", stiffness: 200 }}
          className="flex items-center justify-center w-20 h-20 bg-black rounded-full mx-auto mb-4 shadow-lg"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <Link
            href="/orders"
            className="flex items-center justify-center px-4 py-3 font-semibold bg-lightGreen text-black rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-md"
          >
