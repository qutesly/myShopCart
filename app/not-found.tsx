      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="mt-8 space-y-6">
          <div className="rounded-md shadow-sm space-y-4">
            <Link
              href={"/"}
              className="w-full flex items-center justify-center px-4 py-2 border border-transparent text-sm font-semibold rounded-md text-white bg-shop_dark_green/80 hover:bg-shop_dark_green focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amazonDarkOrange hoverEffect"
            >
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link
              href="/contact"
              className="font-semibold text-amazon-blue hover:text-amazon-blue-dark"
            >
              contact us
            </Link>
          </p>
